...
const ScrollIndicator = () => {
  ...
  return (
    <div id="scroll-indicator-container" className="flex flex-col items-center space-y-2 mb-2 sm:row-start-4 sm:col-span-2" style={{ opacity }}>
      <p id="scroll-text" className="text-xs font-light">Scroll to Discover</p>
