...
const Landing = () => {
    return (
        ...
        >
            ...
            <h3 id="my-name-is" className="h-max text-[22px] xs:text-3xl leading-none sm:col-start-1 sm:row-start-3 mt-4 sm:mt-0">
                My name is&nbsp;
                <span className="relative h-6 xs:h-9 bg-gradient-to-r from-brown via-green-600 to-sky-500 inline-block text-transparent bg-clip-text">
                    Edgar Teong
