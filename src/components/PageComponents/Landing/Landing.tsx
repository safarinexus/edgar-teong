...
const Landing = () => {
    ...
    return (
        <div 
            id="landing" 
            className="w-full max-w-[1200px] h-svh min-h-max pt-[110px] xs:pt-[120px] sm:pt-[140px] pr-5 pl-5
                grid grid-cols-1 gap-1 sm:gap-3 items-center sm:grid-cols-[60%_40%] sm:grid-rows-[10%_auto_20%_52px]
                ml-auto mr-auto sm:p-24 sm:pb-1
            "
        >
            <Headshot />
            
            <h1 id="hey-there"className="text-center sm:text-left font-extralight text-[5vw] xs:text-[5vw] sm:text-2xl sm:col-start-1 sm:row-start-1 sm:self-end">
                <span className="animate-wave inline-block">👋</span> 
                &nbsp;Hey there!
            </h1>
            <h3 id="my-name-is" className="font-domine text-[9vw] xs:text-[8vw] sm:text-3xl leading-none text-center sm:text-left sm:col-start-1 sm:row-start-3 sm:self-start">
                My name is&nbsp;
