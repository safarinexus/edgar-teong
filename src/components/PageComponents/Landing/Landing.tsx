...
const Landing = () => {
    return (
        <div 
            ...
            "
        >
            {/*can consider adding a button here that links to the contact me so you don't have to have links in two places*/}
            <Headshot />
            ...
            <h3 id="my-name-is" className="font-domine text-[7vw] xs:text-3xl leading-none sm:col-start-1 sm:row-start-3 mt-4 sm:mt-0">
                ...
                <span className="relative bg-gradient-to-r from-amber-600 via-green-500 to-sky-400 inline-block text-transparent bg-clip-text">
                    Edgar Teong
                    <svg className="absolute -bottom-3 w-full scale-0 origin-left transition-transform animate-highlight left-0 h-auto -z-10 transform translate-y-1/3 saturate-200" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 20">
