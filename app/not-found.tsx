...
export default function NotFound() {
    return (
        <div id="error-container" className="w-full h-svh px-2 pt-2">
            <div className="w-full max-w-[1192px] h-[400px] p-10 mx-auto flex flex-col justify-end rounded-[32px] 
            bg-white border-[1px] border-neutral-300 shadow-custom text-black"
            >
