...
export default function Thoughts() {
    ...
    return (
        <main id="thoughts-container" className="w-full h-svh min-h-fit px-2 pt-2">
            ...
            >
                <h1 className="font-medium text-4xl sm:text-6xl lg:text-8xl group text-black">
                    My Thoughts{" "}
                    <Image
                ...
                <small className="sm:text-base lg:text-xl text-black">Take a peek into what goes on in my head.</small>
            </header>
