    ...
    return (
        <>
            ...
            <div id="about-text-container" className="w-full px-5 sm:px-24 font-light text-base">
                ...
                I&#39;m in the midst of getting my Bachelor&#39;s from <a href="https://www.smu.edu.sg/"><span className="font-bold">Singapore Management University</span> in <span className="font-bold">Accountancy &amp; Information Systems</span></a>
                <br /><br />
