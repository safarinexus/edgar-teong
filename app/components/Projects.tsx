...
const Projects = () => {
    ...
    return (
        <>
                        ...
                        >
                            ...
                            <div className="flex flex-wrap space-x-3 pt-1 pb-3 w-10/12">
                                {project.technologies.map((tech, techIndex) => (
                                        <span key={techIndex}>
                                            < TechIcon customTWprop={"size-6"} technology={tech} />
                                        </span>
                                ))}
                            </div>
                        </div>
            ...
            <a href="https://github.com/edgargle?tab=repositories" target="_blank" className="inline-block w-fit font-bold text-lg group">
